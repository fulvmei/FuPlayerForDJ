...
public class BottomDialog extends AppCompatDialog {
    ...
    private FrameLayout ensureContainerAndBehavior() {
        if (container == null) {
            ...
            CornerRadiusFrameLayout bottomSheet = container.findViewById(R.id.design_bottom_sheet);
            behavior = BottomSheetBehavior.from(bottomSheet);
            behavior.addBottomSheetCallback(bottomSheetCallback);
            behavior.setHideable(cancelable);

            bottomSheet.getLayoutParams().height=1500;

            bottomSheet.setCornerRadius(200);
        }
        return container;
    }
